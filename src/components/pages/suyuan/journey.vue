    ...
    export default{
        ...
        methods:{
            traceBack(){
                ...
                this.$get(APIUrl.traceBack,params)
                    .then((response) => {
                        ...
                        {
                            this.journey=response.data.info;
                            // console.log(this.journey.order_status)
...
<style>
    ...
    .journey {position: fixed;width: 100%;height:100%;}
    .journey address{text-align: center;
        font-size: 10px;
        padding: 8% 0;
        position: fixed;
        bottom: 5.5%;
        width: 100%;}
    .journey{background:#C5E3D0;padding-top:3%;}
    .journey .solution{
        /*height: 81%;*/
        /*position: fixed;*/
        background: white;
        ...
        border-radius: 5px;}
    .journey .solution div{border-left:2px solid #1A763D;font-size:14px;height:16.6%;}
    .journey .solution div:nth-child(n+2){color:#808080;border-left: 2px solid #808080;padding:0% 0 12% 4%;}
    .journey .solution div:nth-child(1){padding:4% 0 10% 4%;}
    .journey .solution div:first-child i+p{color:#1A763D;}
    .journey .solution div i{position:fixed;left:5.2%;}
    .journey .solution div:first-child i{color:#1A763D;}
@media(max-width:320px){
        .journey .solution div i{left:4.6%;}
    }@media(min-width:320px max-width:360px){
        .journey .solution div i{left:5.5%;}
    }
@media(min-width:360px max-width:412px){
        .journey .solution div i{left:5.8%;}
    }
